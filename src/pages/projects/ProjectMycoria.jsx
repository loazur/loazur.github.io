  ...
  return (
    <ProjectLayout {...projectData}>
      <section className="project-section">
        ...
        <p>
          <strong>Project Mycoria</strong> est un jeu 3D d'exploration et
          narratif se déroulant dans la vallée du
          <strong> Livradois-Forez</strong>, durant l'hiver.
        </p>
        <p>
          Incarnez <strong>Vincent Morel</strong>, agent de la DGSI, venu
          enquêter sur une
          <strong> étrange maladie</strong> trouvant son origine dans la
          mystérieuse entreprise pharmaceutique
          <strong> Mycoria</strong>.
        </p>
        <p>
          Le jeu permet de traverser le parc naturel du Livradois-Forez tout en
          suivant une histoire originale inspirée par l'affaire du{" "}
          <strong>"pain maudit"</strong>, mystérieux événement ayant frappé le
          village de Pont-Saint-Esprit, dans le Gard durant l'été 1951.
        </p>
      </section>
      ...
      <section className="project-section">
        ...
        <p>
          Le jeu se déroule dans un environnement hivernal fidèle au parc
        ...
        <ul>
          ...
          <li>
            Ambiance sonore immersive (son et musique recommandés via casque)
          </li>
        </ul>
      </section>
      ...
      <section className="project-section">
        ...
        <p>
          <strong>Rubysoft</strong> - Équipe de 6 développeurs :
        </p>
        <ul>
          <li>
            <strong>Lucas CONTRERAS-HODAPP</strong> - Chef de projet /
            Développeur
          </li>
          <li>
            <strong>Clément BOUNAIX</strong> - Gameplay Programmer
          </li>
          <li>
            <strong>Lucas CHAPON</strong> - Scénariste et Builder
          </li>
          <li>
            <strong>Clément ROUVEURE</strong> - Builder
          </li>
          <li>
            <strong>Maël MACE</strong> - Scénariste et Programmer
          </li>
          <li>
            <strong>Mathias BONNEFOUX</strong> - Sound Designer
          </li>
          <li>
            <strong>Jocelyn GUILLON</strong> - Développeur
          </li>
        </ul>
      </section>
      ...
      <section className="project-section">
        ...
        <ul>
          ...
          <li>
            Programmation de mécaniques de combat (tir, visée, rechargement)
          </li>
